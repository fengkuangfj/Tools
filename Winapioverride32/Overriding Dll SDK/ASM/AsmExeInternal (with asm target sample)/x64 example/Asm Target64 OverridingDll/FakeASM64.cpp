...
// your fake asm sources are in .asm file (like AsmRotate64.asm)
///////////////////////////////////////////////////////////////////////////////
extern "C" void mRotateRegisters();
#pragma comment (lib,"FakeAsm64.lib")
...
STRUCT_FAKE_API pArrayFakeAPI[]=
{
    ...
    {_T("EXE_INTERNAL_RVA@0x10C1"),_T("RotateRegisters"),(FARPROC)mRotateRegisters,0,0},
