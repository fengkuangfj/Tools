...
@rem asm -> obj
@ml64.exe /c /Cx /W3 /Zi FakeAsm64.Asm 


@rem obj -> lib (allow #pragma comment(lib,"FakeAsm64.lib") usage in source code and avoid manual inclusion of obj files
@lib.exe FakeAsm64.obj /out:FakeAsm64.lib